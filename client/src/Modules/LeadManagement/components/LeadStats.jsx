      ...
      {categories.map((cat) => {
        ...
        return (
          <button
            ...
            className={`w-full p-3 sm:p-4 rounded-2xl text-left cursor-pointer transition-all duration-200 group flex items-center justify-between h-24 bg-white border shadow-sm relative overflow-hidden ${
              isActive 
